[original hackmd](https://hackmd.io/a2YIx-2pSam9Xkpl9cgYrg)
...
* [x] (MRB) move all creds from keybase to 1password?
  * would allow us to hold the 2FA tokens in the same spot

### Your **new**() agenda items

[x] (mattip) [PyPy 3.7](https://github.com/conda-forge/conda-forge-pinning-feedstock/pull/1024) migration: merge as is (which would cause another PR for people who have not merged pypy3.6) or try to work out a way to skip the failing Py3.6 builds. Concllusion: merge as is and ~300 feedstocks will get an extra PR (that probably will not be merged)

* [x] (CJ) Python symbol extraction from conda-forge packages
  * https://github.com/symbol-management/cf-symbol-table

### Pushed to next meeting

* [ ] (WV) (deferring again  :/)(Will do this via blog post and next meeting) Quick Update on the current state of Quetz / beta.mamba.pm
