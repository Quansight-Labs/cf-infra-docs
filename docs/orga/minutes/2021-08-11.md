...
- [ ] (MRB) merge all open CFEPs as deferred
- [ ] (FF) SDG
- [ ] (FF) move from master to main
  - Useful: https://github.com/asottile/all-repos
  - Plone community: https://community.plone.org/t/rename-master-branch-to-main-on-all-plone-repositories/13692
  - GitHub’s docs: https://github.com/github/renaming
