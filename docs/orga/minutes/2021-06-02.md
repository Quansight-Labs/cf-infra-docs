[hackmd](https://hackmd.io/gb3Rqs_iSWSCl2FvrBVrvA)
...
- [x] (CJ) scipy talk?
- [x] (MRB) more intel compiler stuff https://github.com/conda-forge/conda-forge.github.io/issues/1449
- [x] (MB) about to merge https://github.com/conda-forge/perl-feedstock/pull/49 (+ https://github.com/conda-forge/conda-forge-pinning-feedstock/pull/936 when updated)
- [x] (WV) Use xsimd for AVX / AVX512 / Neon detection in conda / mamba?
  - https://github.com/xtensor-stack/xsimd/blob/master/include/xsimd/config/xsimd_arch.hpp
