  ...
  return (
    <div className={[styles.about, styles.section_padding].join(" ")}>
      <div className={styles.about_description}>
        ...
        <p>
          <Link to="https://github.com/conda-forge">conda-forge</Link> is a
          GitHub organization containing repositories of conda recipes.
        </p>
      </div>
      ...
      <div className={styles.about_video_description}>
        <p>
          ...
          <Link to="/docs">docs</Link> or watching the following episode of{" "}
